...
- [x] **실측 성능(RTINGS 등)**(`measurement` 테이블, `scripts/load_measurements.py`) — HDR 실측 피크·입력랙·DCI-P3·rec2020·명암비. **14종**(QM9K 5413·U8Q 4300·S95F 3789·U7Q 3000·QM8K 2752·QN90F 2500·G5 2272·QN90D 2100·QM7K 1731·XR80II 1681·G4 1500·S90F 1300·C5 1075·XR50 769 nit), 출처(source) 표기. API `GET /api/measurements?model=`. ※DisplaySpecifications 봇차단·TechSpecs API 키필요로 미연동(tuner/vesa_mm 컬럼만 준비).
