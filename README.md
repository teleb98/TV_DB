...
- [x] **Sharp·Vizio 신규 브랜드 추가(14·15번째)** — 미국 시장 확장: **Sharp AQUOS XLED**(4T-C65FV1U, Mini-LED 2000+존·1500nit·Xtreme Brightness+Deep Chroma QD·85W Harman/Kardon, Google-TV, 65/75″, $3099) + **Vizio Quantum Pro**(VQP65C-84, QLED 1000nit·120Hz·FreeSync Premium Pro·4×HDMI2.1, 65/75″, $698). Vizio는 자체 OS라 **smart_os enum에 'SmartCast' 신규 추가**(schema.sql + 운영DB ALTER TYPE) 후 반영 — Walmart 인수 후 재편된 라인업. 총 15브랜드·166모델.
- [x] **중국어 사이트 추적: 화웨이·TCL 신모델 4종 추가** — 중국어 사이트(huawei.com·ithome·zol 등) 크롤링으로 신규 확인: **화웨이 Vision智慧屏6 Pro**(Super MiniLED 黑晶屏·2000nit·288Hz·130W음향·128GB, 65/75/85″) + **화웨이智慧屏V6**(V시리즈, 2100nit·灵犀笔+지향리모컨 표준, 75/85/98″, 7999~14999元) + **TCL Max163M/Max163M Pro**(163″ Micro-LED 巨幕, 2488만+ 자발광칩·**10000nit**·4K, Pro=120Hz, 249999/349999元). backlight_tech=self-emissive(MicroLED). (Hisense 163MX는 여전히 휘도·가격 미공개로 보류 — TCL Max163M은 스펙 완비로 반영)
- [x] **Panasonic 신규 브랜드 추가(13번째)** — 유럽 프리미엄 OLED 브랜드 신규 편입: **Z95B**(2025 flagship, Primary RGB Tandem WOLED·2200nit·144Hz·HCX Pro AI MK II, 55/65/77″) + **Z90B**(2025 high, Master OLED Pro(OLED EX)·950nit·144Hz, 42~77″). OS=Fire-TV(Fire TV Built In, UK/EU). Country=일본, feature 템플릿(ThermalFlow·Filmmaker Mode·전면스피커+30W 서브우퍼) 신설. (Z85C/Z86C 2026 신모델은 정확한 휘도 미공개로 보류)
- [x] **글로벌 신규 2종 추가(IFA/하반기 크롤링)** — **Hisense S7 CanvasTV**(2026, The Frame 경쟁 아트TV, QLED Hi-Matte 매트 반사방지·144Hz·Dolby Vision IQ·Art Mode 1000+작품, 50~85″, US Google TV) + **TCL RM7L**(2026 글로벌 RGB Mini-LED 엔트리, 2000nit·1344~2880존·144Hz(288Hz)·B&O 사운드, 65~98″, EU £1299~). backlight_tech=RGB-Mini-LED. 총 158모델. (Hisense 163MX Micro-LED는 스펙 부족으로 보류)
- [x] **중국 RGB Mini-LED 2종 추가(3차)** — 추가 리서치로 스펙 확보 후 반영: **Hisense E8S Pro**(2025, RGB Mini-LED, **6200nit** XDR Pro·9360존·100% BT.2020·Devialet·330Hz, 75~100″, 16599~29999元) + **TCL Q9M**(2025, RGB Mini-LED 4세대, 2000nit·2880존·7000:1·MediaTek 9655+, 65~98″, 7999~19999元). backlight_tech=RGB-Mini-LED. 총 156모델.
- [x] **2026 중국 년중 신제품 크롤링·추가(2차, 총 6종)** — 웹 크롤링으로 중국 내수 신규 런칭 반영. **TCL Q9M Pro**(SQD-Mini-LED 플래그십 5000nit·3552존)·**T7M Ultra**(SQD 3000nit·2176존)·**T7M Pro**(SQD 2200nit XDR·150Hz·Onkyo) + **Hisense E8N Pro**(Mini-LED 144Hz)·**E8Q Pro**(Mini-LED 3000nit·8320존·Devialet·330Hz) + **Xiaomi Redmi X 2026**(Mini-LED 1200nit·가성비 2499元起). 삼성·LG·Sony 글로벌 2026 라인업은 이미 완비 확인. 총 154모델·CNY 가격 28변형.
